...
The capture steps are in [`docs/capture_protocol.md`](docs/capture_protocol.md) (one A4 page, also as PDF), and the device matrix is in [`docs/device_matrix.md`](docs/device_matrix.md). Every number above is regenerated by a script in `bench/` (see "Reproduce" below).

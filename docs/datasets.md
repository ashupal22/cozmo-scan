...
| **[BD3](https://github.com/Praveenkottari/BD3-Dataset)** building defects | Class check for damage detection: 3,965 phone photos of algae, major/minor crack, peeling, spalling, stain, normal | A-DMG-DETECT (class only) | Image-level labels | **No license stated**: local evaluation only, never redistributed or used to train shipped weights | ~13 MB | Later (step 8) |
